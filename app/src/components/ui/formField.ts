 ...
 * (`ActivityLibraryPage.tsx` and friends) doesn't redefine the same class
 * strings a second time — CLAUDE.md's "never create visually duplicated
 * components" rule applied to a plain style constant, not just a component.
 */
